...
function PortfolioTwo() {
  return (
    ...
    <div className='portfoliotwo-head d-flex justify-content-center flex-column align-items-center'>
        ...
        <div className='portfoliotwo-card-sectone d-flex justify-content-around'>
        ...
        <div className='portfolio-button mt-5  d-flex justify-content-center'>
            <Link className='' to='/' style={{textDecoration:'none', color: 'white', border: '1px solid #004C4C', padding: '2px 15px 2px 15px', backgroundColor: 'black', borderRadius: '5px'}}>Check Now</Link>
        </div>
    </div>
    </>
  )
